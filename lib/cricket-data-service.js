...
import { cricbuzzFetch } from "./api-clients"
...
export class CricketDataService {
     ...
     */
    static async getPointsTable(seriesId) {
    ...
    static async getMatchDetails(id) {
        ...
        try {
            const data = await withBackoff(() => cricbuzzFetch(`msc/v1/m3/${id}/scorecard`))
            const match = data || {}
