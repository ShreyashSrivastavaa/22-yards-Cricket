...
export async function cricApiFetch(endpoint: string, params?: Record<string, string>) {
...
export async function espnScrape(espnUrl: string): Promise<string> {
    ...
    return json.contents as string // Raw HTML
}
 ...
 */
export function parseEspnStatsTable(html: string): Record<string, string>[] {
...
export type TeamCode = typeof IPL_TEAMS[number]["code"]
