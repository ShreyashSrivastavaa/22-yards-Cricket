...
const ROLE_LIMITS: Record<string, [number, number]> = {
    WK: [1, 4],
    BAT: [3, 6],
    AR: [1, 4],
    BOWL: [3, 6],
 ...
 */
export function generateFantasyTeam(pool: FantasyPlayer[]): FantasyTeam {
    const team: FantasyPlayer[] = []
 ...
 */
export function getDifferentialPicks(pool: FantasyPlayer[], limit = 5): FantasyPlayer[] {
    return pool
 ...
 */
export function getMustHavePicks(pool: FantasyPlayer[], limit = 3): FantasyPlayer[] {
    return pool
