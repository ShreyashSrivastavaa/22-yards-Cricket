 ...
 */
export async function getFromCache(table, key, keyColumn, dataColumn, ttlHours) {
    try {
 ...
 */
export async function setCache(table, keyColumn, keyValue, dataColumn, data, extraColumns) {
    try {
        await supabaseAdmin
            .from(table)
            .upsert(
