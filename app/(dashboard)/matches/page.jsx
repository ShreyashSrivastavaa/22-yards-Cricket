...
export default function MatchesListPage() {
    ...
    const allMatches = [
        ...(liveData?.matches?.flatMap(t => t.seriesMatches?.flatMap(s => s.seriesAdWrapper?.matches || [])) || []),
        ...(upcomingData?.matches?.flatMap(t => t.seriesMatches?.flatMap(s => s.seriesAdWrapper?.matches || [])) || [])
    ]
