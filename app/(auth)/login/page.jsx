            ...
            < Card className="w-full max-w-md bg-[#111111] border-[rgba(245,240,232,0.08)] rounded-none relative z-10 shadow-2xl">
                <CardHeader className="space-y-6 text-center border-b border-[rgba(245,240,232,0.05)] pb-10 bg-[#0D0D0D]">
                    ...
                    <div className="space-y-2">
                        <CardTitle className="text-4xl font-bebas tracking-[0.2em] uppercase text-[#F5F0E8] uppercase">Access <span className="text-[#C9A84C]">Terminal</span></CardTitle>
...
export default function LoginPage() {
    return (
        <Suspense fallback={
            <div className="min-h-screen bg-[#0A0A0A] flex items-center justify-center text-[#C9A84C] font-mono text-xs tracking-widest uppercase">
