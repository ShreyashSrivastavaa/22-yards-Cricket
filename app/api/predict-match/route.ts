...
export async function GET(request: NextRequest) {
    ...
    try {
        ...
        const team1 = teams.find((t: any) => t.teamCode === team1Code || t.teamName?.includes(team1Code))
        const team2 = teams.find((t: any) => t.teamCode === team2Code || t.teamName?.includes(team2Code))
