...
interface PlayerRadarProps {
    stats: {
        attack: number      // Strike Rate normalized
        consistency: number  // Average normalized
        power: number       // Boundary % normalized
        clutch: number      // Clutch Score normalized
        pressure: number    // dot ball % or pressure index
    }
}

export function PlayerRadarChart({ stats }: PlayerRadarProps) {
    const data = [
