...
export default function PlayerCharts({ playerId }: { playerId: string }) {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="font-mono text-sm uppercase text-muted-foreground">— Pcae vs Spin Distribution</CardTitle>
                </CardHeader>
                <CardContent className="h-[300px]">
                    <ResponsiveContainer width="100%" height="100%">
                        <PieChart>
