...
const generateZoneData = (batterId: string, bowlerId: string) => {
...
const getHeatColor = (sr: number): string => {
...
const getRiskLabel = (sr: number): string => {
...
export default function MatchupHeatmap({ batterId, bowlerId }: { batterId: string; bowlerId: string }) {
